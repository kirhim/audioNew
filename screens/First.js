...
import { StyleSheet, Text, View, ScrollView, Animated, Image, ImageBackground, Dimensions, SafeAreaView, Button} from 'react-native';
  ...
  render() {
          ...
          <Animated.View style={{ backgroundColor:'gray',height:this.animatedHeaderHeight}}>
            <Animated.View style={{paddingLeft:10,paddingRight:10,flexDirection:'row', marginHorizontal:0, position:'relative'}}>
                 ...
                 <Button title="button" onPress={()=> this.props.navigation.navigate('Settings')}/>
            </Animated.View>
          </Animated.View>
