...
const CONTACTS = [
  { name: 'Marddddwfewfgewfgewissa Castillo', number: 7766398169 },
  { name: 'Denzel Cfwefewfurry', number: 9394378449 },
  { name: 'Miles Fwgrwgrwgerguson', number: 8966872888 },
...
export default class ContactsList2 extends Component  {
  _renderItem = ({ item }) => (
